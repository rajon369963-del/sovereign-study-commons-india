#!/usr/bin/env python3
"""Physical kill-mutant court for Issue #99.

Bypass exactly one commit/tree/script provenance guard at a time in a temporary
copy of the current production verifier and require the corresponding existing
discriminator test to go RED. This proves target-stage mechanism sensitivity.
"""
